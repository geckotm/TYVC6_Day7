...
BEGIN_MESSAGE_MAP(CFontsDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_EXIT, &CFontsDlg::OnClickedExit)
END_MESSAGE_MAP()
...
void CFontsDlg::FillFontList()
{
	...
	// Create a device context varible
	CClientDC dc(this);

	// Enumerate the font families
	::EnumFontFamilies((HDC)dc, &lf, (FONTENUMPROC)EnumFontFamProc, (LPARAM) this, 0);
